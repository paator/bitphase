...
<button
	type="button"
	class="cursor-pointer rounded border px-2 py-0.5 text-[0.65rem] font-medium transition-colors {classic
		? 'border-[var(--color-pattern-note)]/50 bg-[var(--color-pattern-note)]/15 text-[var(--color-pattern-note)]'
